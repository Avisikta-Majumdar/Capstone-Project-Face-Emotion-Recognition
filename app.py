...
def main():
    ...
    st.sidebar.markdown( """Developed By Avisikta Majumdar<a href="https://www.linkedin.com/in/avisikta-majumdar//">Aviskta Majumdar LinkedIn</a>""", unsafe_allow_html=True,)
